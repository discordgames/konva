...
class Node {
    ...
    draw() {
        ...
        if (this._drawAccumulation >= this._drawRate) {
            ...
            this.drawScene();
            if (this._refreshHit === true && Global_1.Konva.hitTestEnabled) {
                this.drawHit();
...
addGetterSetter(Node, 'x', 0, (0, Validators_1.getNumberValidator)(), refresh);
addGetterSetter(Node, 'y', 0, (0, Validators_1.getNumberValidator)(), refresh);
...
addGetterSetter(Node, 'rotation', 0, (0, Validators_1.getNumberValidator)(), refresh);
Factory_1.Factory.addComponentsGetterSetter(Node, 'scale', ['x', 'y'], undefined, refresh);
addGetterSetter(Node, 'scaleX', 1, (0, Validators_1.getNumberValidator)(), refresh);
addGetterSetter(Node, 'scaleY', 1, (0, Validators_1.getNumberValidator)(), refresh);
Factory_1.Factory.addComponentsGetterSetter(Node, 'skew', ['x', 'y'], undefined, refresh);
addGetterSetter(Node, 'skewX', 0, (0, Validators_1.getNumberValidator)(), refresh);
addGetterSetter(Node, 'skewY', 0, (0, Validators_1.getNumberValidator)(), refresh);
Factory_1.Factory.addComponentsGetterSetter(Node, 'offset', ['x', 'y'], undefined, refresh);
addGetterSetter(Node, 'offsetX', 0, (0, Validators_1.getNumberValidator)(), refresh);
addGetterSetter(Node, 'offsetY', 0, (0, Validators_1.getNumberValidator)(), refresh);
addGetterSetter(Node, 'dragDistance', null, (0, Validators_1.getNumberValidator)());
addGetterSetter(Node, 'width', 0, (0, Validators_1.getNumberValidator)(), refresh);
addGetterSetter(Node, 'height', 0, (0, Validators_1.getNumberValidator)(), refresh);
...
addGetterSetter(Node, 'visible', true, (0, Validators_1.getBooleanValidator)(), refresh);
